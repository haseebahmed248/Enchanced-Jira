...
//     setUserId(null); // Reset user ID when closing profile
//   };
...
//         </Toolbar>
//       </Container>
//       {profileOpen && <ProfileComponent onClose={handleCloseProfile} userId={userId} />}
//     </AppBar>
//   );
// }
...
function J_AppBar() {
  ...
  const [anchorElUser, setAnchorElUser] = useState(null);
  const [profileOpen, setProfileOpen] = useState(false); 
  const userId = useContext(UserContext); // Assuming the user's email is stored in the context
